...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            Logic of suppliers
                - salesman can handle only normal stuff
        ...
        */
        ...
        Order order2 = new Order(2, 500,5,supplier3);
        Order order3 = new Order(3, 110,2,supplier2);
        Order order4 = new Order(4,670,4,supplier2);
        Order order5 = new Order(5, 190,1,supplier3);
